...
public class RecoveryIndexerTest {
  ...
  private Settings emptySettings = new MapSettings();

  @Rule
  public final EsTester es = new EsTester(new UserIndexDefinition(emptySettings), new RuleIndexDefinition(emptySettings));
  @Rule
